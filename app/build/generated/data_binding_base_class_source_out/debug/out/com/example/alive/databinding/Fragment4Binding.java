...
public final class Fragment4Binding implements ViewBinding {
  ...
  private Fragment4Binding(@NonNull LinearLayout rootView, @NonNull Button btnCancel,
  ...
  public static Fragment4Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Fragment4Binding((LinearLayout) rootView, btnCancel, progressBar);
    }
